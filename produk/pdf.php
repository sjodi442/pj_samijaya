<?php
include"../koneksi.php";
$sql=mysqli_query($konek,"SELECT * FROM produk ORDER BY id_produk");
$data = array();
...
$judul = "DATA PRODUK";
$header = array(
array("label"=>"ID Produk", "length"=>30, "align"=>"L"),
array("label"=>"Nama Produk", "length"=>50, "align"=>"L"),
array("label"=>"Harga Produk", "length"=>30, "align"=>"L"),
array("label"=>"Stok Produk", "length"=>30, "align"=>"L"),
);
//memanggil fpdf
ob_start();
