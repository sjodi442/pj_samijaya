...
<h2 align="center">Data Jurnal Kas</h2>
<table align='center' border=1>
	<tr>
		<th>No Transaksi</th><th>Tanggal Transaksi</th><th>Keterangan</th><th>Debet</th><th>Kredit</th>
	</tr>
			<?php
			...
			<tr>
				...
				<td align="right"><b><?php if(!empty($tot_debet)){ echo number_format($tot_debet,0,'.',','); } ?></b></td>
				<td align="right"><b><?php if(!empty($tot_kredit)){ echo number_format($tot_kredit,0,'.',','); }?></b></td>
			</tr>
			<?php
